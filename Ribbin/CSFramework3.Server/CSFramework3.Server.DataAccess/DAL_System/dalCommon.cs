...
namespace LZHBaseFrame.Server.DataAccess.DAL_System
{
    public class dalCommon : dalBase, IBridge_CommonData
    {
        ...
        public DataTable GetDB4Backup()
        {
            ...
            sb.AppendLine("UNION ");
            sb.AppendLine("SELECT 'LZHBaseFrame.System','系统数据库'");
        ...
        /// 备份数据库
        /// </summary>
        /// <param name="DBNAME">数据名称。如：LZHBaseFrame22.Normal</param>
        ...
        /// 还原数据库
        /// </summary>
        /// <param name="BKFILE">备份的文件。如：C:\LZHBaseFrame22.Normal_2010.bak</param>
        /// <param name="DBNAME">数据名称。如：LZHBaseFrame22.Normal</param>
