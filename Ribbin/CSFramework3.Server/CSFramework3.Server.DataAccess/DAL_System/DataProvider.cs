...
using LZHBaseFrame.Core.DomainDataProvider;
...
namespace LZHBaseFrame.Server.DataAccess.DAL_System
{
    ...
    public class DataProvider
    {
        ...
        //{
        //    get { return DataProvider._DBName; }
        //    set { DataProvider._DBName = value; }
        //}
        /// <summary>
        /// 访问层实例
        /// </summary>
        ...
        //{
        //    DBName = dbName;
        //    IPersistBroker persisBroker = PersistBrokerManager.PersistBroker(GetConnectionString(DBName));
        //    domainDataPrivider = DomainDataProviderManager.DomainDataProvider(persisBroker,null);
        //}

        public Core.Domain.IDomainDataProvider GetCusDataProvider(string DBName)
        {
            Core.Domain.IDomainDataProvider dataProvider = Core.DomainDataProvider.DomainDataProviderManager.DomainDataProvider(Core.PersistBroker.PersistBrokerManager.PersistBroker(GetConnectionString(DBName)), null);
            return dataProvider;
