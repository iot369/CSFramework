...
using LZHBaseFrame.Interfaces.Interfaces_Bridge;
using LZHBaseFrame.Bridge.DataDictModule;
using LZHBaseFrame.Bridge.SalesModule;
using LZHBaseFrame.Bridge.SystemModule;
using LZHBaseFrame.Bridge.CommonBridge;
using System.IO;
using LZHBaseFrame.Core;
using System.ServiceModel;
using System.Windows.Forms;
using LZHBaseFrame.WebServiceReference;
using LZHBaseFrame.WebServiceReference.WCF_CommonService;

namespace LZHBaseFrame.Bridge
{
    /// <summary>
    ...
    public class BridgeFactory
    {
        ...
        /// 数据访问层模块文件名
        /// </summary>
        public const string DLL_FILE_NAME = "LZHBaseFrame.Server.DataAccess.dll";
        ...
        public static bool InitializeBridge()
        {
            ...
            try
            {
                ...
                if (BridgeType.ADODirect == BridgeType)
                {
                    ...
                    //IWriteSQLConfigValue cfgSQLExpress = new SQLExpressCfg(Application.StartupPath + @"\LZHBaseFrame.ini");
