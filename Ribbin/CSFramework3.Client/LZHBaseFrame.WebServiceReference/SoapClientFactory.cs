...
using LZHBaseFrame.WebServiceReference.WCF_CommonService;
using LZHBaseFrame.WebServiceReference.WCF_SalesModuleService;
using LZHBaseFrame.WebServiceReference.WCF_DataDictService;
using LZHBaseFrame.WebServiceReference.WCF_SystemSecurityService;
using LZHBaseFrame.Common;
using LZHBaseFrame.WebServiceReference.WCF_PurchaseModuleService;
using LZHBaseFrame.WebServiceReference.WCF_InventoryModuleService;
using LZHBaseFrame.WebServiceReference.WCF_AccountModuleService;
namespace LZHBaseFrame.WebServiceReference
{
