...
namespace LZHBaseFrame.ORM
{
    ...
    public sealed class GenerateTableFields : IClassGenerator
    {
        ...
        /// ORM类所在命名空间
        /// </summary>
        const string _ORM_Namespace = "LZHBaseFrame.ORM";
        ...
        private void CreateComment(StringBuilder builder, string concretelyName)
        {
            ...
            builder.AppendLine(" *   作者姓名: C/S框架网 www.LZHBaseFrame.com");
            ...
            builder.AppendLine(" *   版权所有 C/S框架网 www.LZHBaseFrame.com");
            builder.AppendLine(" *==========================================*/");
            builder.AppendLine("");
        }
    }
