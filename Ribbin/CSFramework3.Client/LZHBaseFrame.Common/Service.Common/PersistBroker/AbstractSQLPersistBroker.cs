...
namespace Service.Common.PersistBroker
{
    ...
    public abstract class AbstractSQLPersistBroker : MarshalByRefObject, IPersistBroker
    {
        ...
        public DataSet Query(string commandText)
        {
            ...
            {
                command.CommandText = commandText;
                //command.CommandTimeout = Enviroment.CommandTimeout;
        ...
        public abstract int Execute(string commandText, string[] parameters, Type[] parameterTypes, object[] parameterValues, bool returnID);
