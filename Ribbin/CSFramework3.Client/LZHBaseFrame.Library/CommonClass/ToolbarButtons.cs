...
namespace LZHBaseFrame.Library
{
 ...
 /// Ribbon按钮
 /// </summary>
    public class RibbonButtonInfo : IButtonInfo
    {
        private BarButtonItem _btn = null;
        private OnButtonClick _clickEvent = null;

        public RibbonButtonInfo(BarManager barManager, string name, string caption, Image image, OnButtonClick clickEvent)
        {
    ...
    public class DevBarButtonInfo : IButtonInfo
    {
        ...
        public DevBarButtonInfo(BarManager barManager, string name, string caption, Image image,DevExpress.XtraBars.Ribbon.RibbonItemStyles style, OnButtonClick clickEvent)
        {
            _btn = new BarButtonItem(barManager, caption);
            _btn.Glyph = image;
            _btn.PaintStyle = BarItemPaintStyle.CaptionGlyph;
