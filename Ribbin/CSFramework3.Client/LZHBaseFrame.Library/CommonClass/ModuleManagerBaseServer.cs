...
namespace LZHBaseFrame.Library
{
    ...
    /// 基于数据库的模块管理器
    /// </summary>
    public class ModuleManagerBaseServer : IModuleManager
    {
        ...
        public ModuleManagerBaseServer(Form mdiMainForm, XtraTabControl tabControlModules)
        {
        ...
        public void LoadModules(IMsg msg, MenuStrip moduleMenus)
        {
            try
            {
                ...
                foreach (ModuleInfo m in _Modules) //枚举模块文件
                {
                    ...
                    msg.UpdateMessage("正在加载:" + loader.GetCurrentModuleName(), 20 + i++ * 2);//显示加载进度
        ...
        //模块顶级菜单的Click事件
        public void menuOwner_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        public void OnBarButtonItemClick(object sender, ItemClickEventArgs e)
        {
            if (e.Item.Tag != null && e.Item.Tag is ToolStripItem)
                (e.Item.Tag as ToolStripItem).PerformClick();
        }
