...
namespace LZHBaseFrame.Core.Domain
{
    ...
    public class FieldMapAttribute : Attribute
    {
        ...
        public FieldMapAttribute(string fieldName, Type dataType, bool allowNull, bool identity)
        {
        ...
        public FieldMapAttribute(string fieldName, Type dataType, int size, bool allowNull)
            : this(fieldName, dataType, allowNull,false)
        {
            this._Size = size;
        }
        public FieldMapAttribute(string fieldName, int size, bool allowNull, bool identity)
            : this(fieldName, typeof(int), allowNull,identity)
        {
            this._Size = size;
        }
