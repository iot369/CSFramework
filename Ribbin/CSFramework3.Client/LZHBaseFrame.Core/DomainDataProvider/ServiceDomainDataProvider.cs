...
namespace LZHBaseFrame.Core.DomainDataProvider
{
	...
	///  据访问提供类
	/// </summary>
	public class ServiceDomainDataProvider:MarshalByRefObject,IDomainDataProvider
	{

		private IPersistBroker _persistBroker;
		private System.Globalization.CultureInfo _cultureInfo;

		public ServiceDomainDataProvider(IPersistBroker persistBroker, System.Globalization.CultureInfo  cultureInfo)
		{
			this._cultureInfo   = cultureInfo;
			this._persistBroker = persistBroker;
		}

        public ServiceDomainDataProvider()
		{
		}
