...
namespace LZHBaseFrame.Core.PersistBroker
{
    ...
    /// </summary>
 /*
    public class ServicePersistBroker : IPersistBroker
    {
        public ServicePersistBroker(string serviceIP)
        {

        }

        public ServicePersistBroker(string serviceIP, System.Globalization.CultureInfo cultureInfo)
        {
        }
        ...
        public override int Execute(string commandText, string[] parameters, Type[] parameterTypes, object[] parameterValues, bool retID)
        {
            ...
            using (SqlCommand command = (SqlCommand)this.Connection.CreateCommand())
            {
                ...
                try
                {
                    ...
                    FileLog.Info(" Parameter SQL:" + this.spellCommandText(command.CommandText, parameterValues));
#endif
